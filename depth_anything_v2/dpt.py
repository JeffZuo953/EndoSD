...
from dinov3.hub.backbones import dinov3_vits16, dinov3_vitb16, dinov3_vitl16, dinov3_vits16plus, dinov3_vith16plus, dinov3_vit7b16
...
class DPTHead(nn.Module):
    def __init__(
        ...
        use_clstoken=False,
        patch_size=14  # 添加 patch_size 参数，默认为14以保持向后兼容
    ):
...
class DepthAnythingV2(nn.Module):
    def __init__(
        ...
        if 'dinov3' in encoder:
            ...
            self.pretrained = model_zoo[encoder](patch_size=14, pretrained=True)
        else:
