...
TRAIN_DATASET_INCLUDE=${TRAIN_DATASET_INCLUDE:-"Kidney3D,RIRS-SegC,RIRS-SegP,clinicDB,CVC-EndoScene,Kvasir-SEG,bkai-igh-neopolyp,ETIS-LaribPolypDB,EndoSynth,EndoVis2017,EndoVis2018"}
VAL_DATASET_INCLUDE=${VAL_DATASET_INCLUDE:-"CVC-EndoScene,RIRS-SegC,Kvasir-SEG,EndoVis2017,EndoNeRF"}
