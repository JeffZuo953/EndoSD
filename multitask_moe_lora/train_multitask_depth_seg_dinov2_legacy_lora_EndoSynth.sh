...
# ==============================================================================
# Multi-Task Training (Depth + Segmentation) — EndoSynth only (LS bundle)
# ==============================================================================
...
SAVE_PATH="${BASE_SAVE_PATH}/multitask_EndoSynth_${ENCODER}_${MODE}_${LOSS_WEIGHTING_STRATEGY}_$(date +%Y%m%d_%H%M%S)"
mkdir -p "${SAVE_PATH}"
exec > >(tee -a "${SAVE_PATH}/training.log") 2>&1

echo "=============================================================================="
echo "EndoSynth-only training — DINOv2 Legacy LoRA"
echo "------------------------------------------------------------------------------"
...
echo "  Train Include:       ${TRAIN_DATASET_INCLUDE}"
echo "  Val Include:         ${VAL_DATASET_INCLUDE}"
