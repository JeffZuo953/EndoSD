...
# ==============================================================================
# Multi-Task Training (Depth + Segmentation) — DINOv2 Legacy LoRA (NO dataset bundle)
# ==============================================================================
...
DATASET_CONFIG_NAME="no_ls_local"
PATH_TRANSFORM_NAME="none"
DATASET_MODALITY="mt"  # mt (multi-task) or fd (depth-focused) for NO bundle
...
SAVE_PATH="${BASE_SAVE_PATH}/multitask_NO_${ENCODER}_${MODE}_${LOSS_WEIGHTING_STRATEGY}_$(date +%Y%m%d_%H%M%S)"
mkdir -p "${SAVE_PATH}"
exec > >(tee -a "${SAVE_PATH}/training.log") 2>&1

echo "=============================================================================="
echo "NO bundle training — DINOv2 Legacy LoRA"
echo "------------------------------------------------------------------------------"
