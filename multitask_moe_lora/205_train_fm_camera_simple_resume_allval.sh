#!/bin/bash
# ==============================================================================
# Foundation Depth Camera Training (VGGT-like head, resume + all-val)
# ==============================================================================
set -euo pipefail
...
RESUME_CHECKPOINT=${RESUME_CHECKPOINT:-"/media/gpuadmin/673eec07-52e0-4ff1-b57e-44d6dc68bc8d/jianfu/checkpoint_latest_simple.pth"}
...
echo "=============================================================================="
echo "FD Depth Training (VGGT-like Camera Head)"
echo "------------------------------------------------------------------------------"
