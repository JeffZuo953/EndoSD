...
def main():
    ...
    # base_dir = '/media/ssd2t/jianfu/data/polyp/CVC-EndoScene/TestDataset'
    # base_dir = '/media/ssd2t/jianfu/data/polyp/CVC-EndoScene/ValidationDataset'
    # base_dir = '/media/ssd2t/jianfu/data/polyp/CVC-EndoScene/TrainDataset'
    ...
    original_dataset = Dataset(original_filelist, origin_prefix, "train", size=(518, 518))  # 'test' 模式
