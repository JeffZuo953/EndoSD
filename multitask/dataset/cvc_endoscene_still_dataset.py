...
class CVCEndoSceneStillDataset(Dataset):
    """
    CVC-EndoScene Still dataset for polyp segmentation.
    Images: 912 images
    Crop non-lens areas (outer frame + four corners)
    """

    def __init__(self, filelist_path, rootpath, mode="train", size=(518, 518), roi_mask_path="/media/ssd2t/jianfu/data/polyp/CVC-EndoScene/valid_mask.png"):
    ...
    def __getitem__(self, item):
        ...
        for ext in image_extensions:
            image_path = os.path.join(self.rootpath, "images", line + ext)
