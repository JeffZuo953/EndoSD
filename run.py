...
# python run.py --img-path /root/c3vd/test_mapping.txt --outdir ./vis_depth --encoder vitl --grayscale
...
if __name__ == '__main__':
    ...
    parser.add_argument('--encoder', type=str, default='vitl', choices=['vits', 'vitb', 'vitl', 'vitg', 'dinov3_vits16', 'dinov3_vits16plus', 'dinov3_vitb16', 'dinov3_vitl16', 'dinov3_vith16plus', 'dinov3_vit7b16'])
